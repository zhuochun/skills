...
6. **Diagnose model friction.** Treat repeated exceptions, flag clusters, generic records, missing terms, awkward transitions, cross-cutting edits, inconsistency, and hidden-history rules as investigation prompts, not pattern mandates.
