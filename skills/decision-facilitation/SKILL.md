...
- Recover user-owned goals, values, authority, participation needs, and risk tolerance before firm recommendation; otherwise label it provisional and name what input could change it.
...
- Own intent, criteria, alternatives, assumptions, tradeoffs, closure, commitments, and reopening. Route specialist judgments to their evidence owner or skill.
...
- Partition questions by decision and disclosure dependency. Batch low-sensitivity questions whose answers stand alone; serialize when earlier answers shape later ones, ambiguity needs follow-up, sensitivity affects candor, or a gate controls relevance.
...
Use a compact pass when evidence is sufficient: recover the frame, test it, and return the smallest useful result. Use interactive clarification then collaborative challenge for grill or stress-test requests, or when user-owned ambiguity blocks progress. Clarify intent and owner criteria before challenging assumptions, alternatives, consequences, and evidence; rigor is not adversarial tone or question volume.
...
3. **Design participation and closure.** Name recommendation, decision, agreement or veto, input, execution, and information roles. Declare closure before debate hardens.
...
- The disposition fits current evidence and authority.
- Closure records accepted risk, execution ownership, verification, and reopening triggers.
...
- Firm recommendations require owner criteria; challenge must add decision value, not perform opposition.
- Route unevaluated specialist claims instead of producing generic checklists.
