...
- `migration-planning` owns the executable old-to-mixed-to-new transition, cutover, recovery, and cleanup sequence. This skill supplies the compatibility matrix, support policy, consumer obligations, and retirement claims.
