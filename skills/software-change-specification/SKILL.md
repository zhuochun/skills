...
4. **Map affected surfaces.** Name relevant journey, entry points, domain decisions, state authority, data lifecycle, consumers, contracts, permissions, dependencies, failure/recovery, telemetry, release controls, and owners. Record confidence; omit irrelevant fields.
