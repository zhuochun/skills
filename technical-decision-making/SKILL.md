...
6. **Test tradeoffs.** Trace important scenarios and failure conditions. Use rough models, prototypes, historical evidence, or `$architecture-risk-evaluation` when architecture assumptions need deeper examination.
