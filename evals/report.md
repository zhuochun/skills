...
structural work from behavior change, and deciding whether architectural
learning warrants reopening a design.
...
Quality and resource efficiency are independent. Specification sometimes
reduced investigation dramatically; diagnosis produced one faster substantive
run; refactoring was cheaper on the bounded case. Code review and retrospective
review bought quality with greater investigation, while implementation showed
no overall efficiency advantage. No skill has a demonstrated monetary-cost
...
- Final-state evidence is narrower for domain modeling, implementation,
  refactoring, and retrospective review because important contract branches
  still need targeted reruns.
