...
Source skill directories live under [`skills/`](skills/). The repository root
is reserved for catalog documentation, evaluation infrastructure, and other
repository-management surfaces.
...
| [`software-change-orchestration`](skills/software-change-orchestration/) | Resumable routing and repository-backed state across a bounded software change | Outcome boundary, persistence mode, canonical work surface, artifact and evidence index, current frontier, and next owned move |
...
Copy-Item -LiteralPath 'D:\GitHub\zhuochun-skills\skills\service-boundary-design' `
...
New-Item -ItemType SymbolicLink `
  ...
  -Target 'D:\GitHub\zhuochun-skills\skills\service-boundary-design'
```
