...
| Skill | It owns | Primary output |
| --- | --- | --- |
| [`agentic-repo-setup`](../skills/agentic-repo-setup/) | Bootstrap with bounded recommendations, task-centered retrofit, and correction-driven renewal of the repository-local coding-agent environment | Decision frontier, minimum logical information architecture, walking skeleton, stable commands, risk-matched evidence, validated renewal dispositions, and a usable bootstrap, demonstrated improvement, or evidence-backed no-op |
